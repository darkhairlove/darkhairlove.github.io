...
![Untitled](../assets/img/posts/TOD/Untitled.png)
...
- **파이프라인(Pipeline)또는 모듈러(Modular) 시스템.**
    ...
    ![Untitled](../assets/img/posts/TOD/Untitled%201.png)
...
- **조합(joint) 시스템**
    ...
    - word-level DST는 NLU와 DST를 결합한 방식이고, Word-level Policy는 Policy와 NLG를 결합한 시스템
        ...
        ![[[2005.07362] Is Your Goal-Oriented Dialog Model Performing Really Well? Empirical Analysis of System-wise Evaluation (arxiv.org)](https://arxiv.org/abs/2005.07362)](../assets/img/posts/TOD/Untitled%202.png)
...
- Annotataion of Dialogue Acts : 대답에 대한 주석 `inform(domain=hotel,price=expensive)`과 같은 것, intent inform 인 경우 사용자가 싼 hotel을 찾는다는 것을 system이 알고 있다.
    ...
    - 주석 처리 하는 과정
        ...
        ![Untitled](../assets/img/posts/TOD/Untitled%203.png)
        
        ![Untitled](../assets/img/posts/TOD/Untitled%204.png)
        
        ![Untitled](../assets/img/posts/TOD/Untitled%205.png)
...
- 10438개의 대화가 수집되었다.
    ...
    ![스크린샷 2023-03-19 오후 2.30.54.png](/assets/img/posts/TOD/21.png)
...
- 총 turn 수는 115,434입니다.
    ...
    ![스크린샷 2023-03-19 오후 2.31.11.png](/assets/img/posts/TOD/20.png)
    
    user와 system(wizards)의 문장 길이의 분포
    
- user의 평균 길이는 11.75, system의 평균 길이는 15.12 즉 system이 더 길다.
    
    ![스크린샷 2023-03-19 오후 2.44.03.png](/assets/img/posts/TOD/19.png)
    
    코퍼스에 달린 dialogue act의 분포
    
    ![스크린샷 2023-03-19 오후 2.47.17.png](/assets/img/posts/TOD/18.png)
...
- 강화학습에 사용에 적용할 수 있다?
    ...
    ![스크린샷 2023-03-19 오후 2.53.46.png](/assets/img/posts/TOD/17.png)
...
![스크린샷 2023-03-19 오후 3.08.50.png](/assets/img/posts/TOD/16.png)
...
![스크린샷 2023-03-19 오후 3.30.58.png](/assets/img/posts/TOD/1.png)
...
- belief tracker는 pre-trained 되어있고, dialogue state의 주석은 oracle tracker을 사용되었다.
    ...
    ![스크린샷 2023-03-19 오후 4.07.30.png](/assets/img/posts/TOD/2.png)
...
- Cam676과 비교
    ...
    ![스크린샷 2023-03-19 오후 4.27.49.png](/assets/img/posts/TOD/3.png)
...
- SFX와 비교
    ...
    ![스크린샷 2023-03-19 오후 4.43.42.png](/assets/img/posts/TOD/4.png)
...
![스크린샷 2023-03-19 오후 6.12.05.png](/assets/img/posts/TOD/5.png)
...
- MultiWOZ 데이터 세트의 delexicalized 버전에서 미세 조정된 GPT-2 모델, 데이터베이스 쿼리 모듈.
    ...
    ![스크린샷 2023-03-19 오후 6.27.38.png](/assets/img/posts/TOD/6.png)
...
![스크린샷 2023-03-19 오후 6.40.50.png](/assets/img/posts/TOD/15.png)
...
![스크린샷 2023-03-19 오후 6.46.30.png](/assets/img/posts/TOD/13.png)
...
- LM : previous word-token으로 next word-token의 likelihood을 계산하는 목적
    ...
    ![스크린샷 2023-03-20 오전 1.03.21.png](/assets/img/posts/TOD/12.png)
...
![스크린샷 2023-03-20 오전 1.16.50.png](/assets/img/posts/TOD/11.png)
...
![스크린샷 2023-03-20 오후 10.06.56.png](/assets/img/posts/TOD/10.png)
...
![스크린샷 2023-03-20 오후 10.15.08.png](/assets/img/posts/TOD/9.png)

- top-p sampling (p=0.8) 으로 1위를 했다.

### Attention Weights

![스크린샷 2023-03-20 오후 10.19.55.png](/assets/img/posts/TOD/8.png)
...
![스크린샷 2023-03-20 오후 10.57.48.png](/assets/img/posts/TOD/7.png)
...
![스크린샷 2023-03-20 오후 11.02.04.png](../assets/img/posts/TOD/Untitle_6.png)
