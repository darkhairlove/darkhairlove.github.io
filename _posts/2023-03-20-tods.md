...
- **파이프라인(Pipeline)또는 모듈러(Modular) 시스템.**
    ...
    ![Untitled](../assets/img/content/TOD/Untitled%201.png)
...
- **조합(joint) 시스템**
    ...
    - word-level DST는 NLU와 DST를 결합한 방식이고, Word-level Policy는 Policy와 NLG를 결합한 시스템
        ...
        ![[[2005.07362] Is Your Goal-Oriented Dialog Model Performing Really Well? Empirical Analysis of System-wise Evaluation (arxiv.org)](https://arxiv.org/abs/2005.07362)](../assets/img/content/TOD/Untitled%202.png)
...
- Annotataion of Dialogue Acts : 대답에 대한 주석 `inform(domain=hotel,price=expensive)`과 같은 것, intent inform 인 경우 사용자가 싼 hotel을 찾는다는 것을 system이 알고 있다.
    ...
    - 주석 처리 하는 과정
        ...
        ![Untitled](../assets/img/content/TOD/Untitled%203.png)
        
        ![Untitled](../assets/img/content/TOD/Untitled%204.png)
        
        ![Untitled](../assets/img/content/TOD/Untitled%205.png)
